...
<div class="container mt-5 mb-5">
  <div class="bg-primary text-white rounded px-3 py-2 mb-4">
    <h4 class="mb-0">TCES dos Alunos</h4>
  </div>

  <form action="CRUD/inserts/inserts_tces.php" class="border border-azul rounded p-4 bg-white shadow-sm" enctype="multipart/form-data" method="post">

...
<div style="margin-top: 90px;"></div>
  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="bg-primary text-white rounded px-3 py-2 mb-4">
      <h4 class="mb-0">Termos Aditivos</h4>
    </div>

    <!-- Início do Formulário -->
    <form action="CRUD/inserts/inserts_aditivos.php" class="border border-azul rounded p-4 bg-white shadow-sm" enctype="multipart/form-data" method="post">
      ...
      <table class="table table-bordered align-middle table-striped">
        <tbody>
          ...
          <tr>
            ...
            <td><input type="date" class="form-control" id="termino_estagio" name="termino_estagio"></td>
            <td><label class="form-label" for="novo_termino_estagio">Novo Término do Estágio</label></td>
            <td><input type="date" class="form-control" id="novo_termino_estagio" name="novo_termino_estagio"></td>
          </tr>
          <tr>

...
<head>
  <meta charset="UTF-8">
  <title>Formulário de Localidades</title>
...
<div style="margin-top: 90px;"></div>
  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="bg-primary text-white rounded px-3 py-2 mb-4">
      <h4 class="mb-0">Localidades</h4>
    </div>

    <!-- Início do Formulário -->
    <form action="CRUD/inserts/inserts_localidades.php" class="border border-azul rounded p-4 bg-white shadow-sm" enctype="multipart/form-data" method="post">
     <div class="table-responsive">    
      <table class="table table-bordered align-middle table-striped">
        <tbody>
          <tr>
            <td><label class="form-label" for="bairro_desc">Bairro</label></td>
            <td colspan="3"><input type="text" class="form-control" id="bairro_desc" name="bairro_desc"></td>
            <td><label class="form-label" for="municipio_desc">Cidade</label></td>
            <td><input type="text" class="form-control" id="municipio_desc" name="municipio_desc"></td>
            <td><label class="form-label" for="Serv_DescUF">UF</label></td>
            <td colspan="3"><input type="text" class="form-control" id="Serv_DescUF" name="Serv_DescUF"></td>
          </tr>
          <tr>

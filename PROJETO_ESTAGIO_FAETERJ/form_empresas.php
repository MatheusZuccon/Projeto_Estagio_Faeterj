...
<head>
  <meta charset="UTF-8">
  <title>Empresas Credenciadas</title>
...
<div style="margin-top: 90px;"></div>
  <div class="container mt-5 mb-5">
    ...
    <div class="bg-primary text-white rounded px-3 py-2 mb-4">
      <h4 class="mb-0">Empresas Credenciadas</h4>
    </div>

    <form action="CRUD/inserts/inserts_empresas.php" class="border border-azul  p-4 bg-white shadow-sm" enctype="multipart/form-data" method="post">
      <table class="table table-bordered align-middle table-striped">
        <tbody>
          <tr>
            <td><label class="form-label" for="empresa">Empresa</label></td>
            <td colspan="3"><input type="text" class="form-control" id="empresa" name="empresa"></td>
          </tr>
          <tr>
            <td><label class="form-label" for="nome_fantasia">Nome Fantasia</label></td>
            <td colspan="3"><input type="text" class="form-control" id="nome_fantasia" name="nome_fantasia"></td>
          </tr>
          <tr>
            <td><label class="form-label" for="area_profissional">Área Profissional</label></td>
            <td><input type="text" class="form-control" id="area_profissional" name="area_profissional"></td>
            <td><label class="form-label" for="situacao">Situação</label></td>
            <td><input type="text" class="form-control" id="situacao" name="situacao"></td>
          </tr>
          <tr>
            <td><label class="form-label" for="vencimento">Vencimento</label></td>
            <td><input type="date" class="form-control" id="vencimento" name="vencimento"></td>
          ...
          <tr>
            ...
            <td colspan="3"><input type="text" class="form-control" id="cidade" name="cidade"></td>
          </tr>
          <tr>

...
<div class="container mt-5 mb-5">
  ...
  <div class="bg-primary text-white rounded px-3 py-2 mb-4">
    <h4 class="mb-0">Seguradoras</h4>
  </div>

  <!-- Início do Formulário -->
  <form action="CRUD/inserts/inserts_seguradora.php" 
      class="border-azul p-4 bg-white shadow-sm" 
      enctype="multipart/form-data" method="post">
   <div class="table-responsive">
    <table class="table table-bordered align-middle table-striped">
      <tr>
        <td><label class="form-label" for="nome">Seguradora</label></td>
        <td colspan="3"><input type="text" class="form-control" id="nome" name="nome"></input></td>
      </tr>
      <tr>
        <td><label class="form-label" for="tipo">Tipo de Convênio</label></td>
        <td colspan="3"><input type="text" class="form-control" id="tipo" name="tipo"></input></td>
      </tr>
      <tr>

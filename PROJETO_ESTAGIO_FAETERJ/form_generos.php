...
<head>
  <meta charset="UTF-8">
  <title>Formulário de Gêneros</title>
...
<div style="margin-top: 90px;"></div>
  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="bg-primary text-white rounded px-3 py-2 mb-4">
      <h4 class="mb-0">Formulário de Gênero</h4>
    </div>

    <!-- Início do Formulário -->
    <form action="CRUD/inserts/inserts_generos.php" class="border border-azul rounded p-4 bg-white shadow-sm" enctype="multipart/form-data" method="post">
     <div class="table-responsive">    
      <table class="table table-bordered align-middle table-striped">
        <tbody>
          <tr>
            <td><label class="form-label" for="genero_tipo">Gênero</label></td>
            <td colspan="3"><input type="text" class="form-control" id="genero_tipo" name="genero_tipo"></td>
          </tr>
          <tr>
            <td><label for="genero_obs" class="form-label">Descrição do Gênero</label></td>
            <td colspan="3"><textarea id="genero_obs" name="genero_obs" rows="4" class="form-control"></textarea></td>
          </tr>
          <tr>

...
<head>
  <meta charset="UTF-8">
  <title>Formulário de Unidades</title>
...
<div style="margin-top: 90px;"></div>
  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="bg-primary text-white rounded px-3 py-2 mb-4">
      <h4 class="mb-0">Unidades de Ensino</h4>
    </div>

    <!-- Início do Formulário -->
    <form action="CRUD/inserts/inserts_unidade.php" class="border border-azul rounded p-4 bg-white shadow-sm" enctype="multipart/form-data" method="post">
     <div class="table-responsive">    
      <table class="table table-bordered align-middle table-striped">
        <tbody>
          <tr>
            <td><label class="form-label" for="nome">Unidade de Ensino</label></td>
            <td colspan="6"><input type="text" class="form-control" id="nome" name="nome"></input></td>
          </tr>
          <tr>
            <td><label class="form-label" for="curso">Curso</label></td>
            <td colspan="3"><input type="text" class="form-control" id="curso" name="curso"></td>
            <td><label class="form-label" for="sigla">Sigla do Curso</label></td>
            <td colspan="3"><input type="text" class="form-control" id="sigla" name="sigla"></td>
          </tr>
          <tr>
            <td><label for="curso_desc" class="form-label">Descrição do Curso</label></td>
            <td colspan="3"><textarea id="curso_desc" name="curso_desc" rows="4" class="form-control"></textarea></td>
          </tr>
          <tr>

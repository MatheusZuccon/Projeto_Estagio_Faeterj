      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownEstagiarios">
            ...
            <li><a class="dropdown-item" href="#"><i class="bi bi-card-list me-2"></i>Gêneros Cadastrados</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUnidades">
            ...
            <li><a class="dropdown-item" href="#"><i class="bi bi-geo me-2"></i>Bairros, Cidades e UFs cadastrados</a></li>
          </ul>
        </li>
...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 60vh;">
  <div class="container-buttons text-center border-azul p-4 shadow-sm" style="max-width: 800px; width: 100%;">
    <h5 class="mb-4"><i class="bi bi-grid-fill me-2"></i>O que você deseja acessar?</h5>
    <div class="row g-3">
      <div class="col-md-6">
        <a href="form_alunos.php" class="btn btn-primary w-100">
          <i class="bi bi-person-plus-fill me-1"></i> Formulário de Alunos
        </a>
      </div>
      <div class="col-md-6">
        <a href="CRUD/reads/read_alunos.php" class="btn btn-primary w-100">
          <i class="bi bi-people-fill me-1"></i> Alunos em Estágio
        </a>
      </div>  
      <div class="col-md-6">
        <a href="#" class="btn btn-primary w-100">
          <i class="bi bi-gender-ambiguous me-1"></i> Formulário de Gêneros
        </a>
      </div>
      <div class="col-md-6">
        <a href="#" class="btn btn-primary w-100">
          <i class="bi bi-gender-ambiguous me-1"></i> Gêneros Cadastrados
        </a>
      </div>
    </div>
  </div>

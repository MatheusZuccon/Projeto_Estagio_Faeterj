...
<div style="margin-top: 90px;"></div>
  ...
  <div class="container mt-5 mb-5">
    ...
    <div class="bg-primary text-white rounded px-3 py-2 mb-4">
      <h4 class="mb-0">Lista de Relatórios de Estágio</h4>
    </div>
          ...
          <tbody>
            <?php foreach ($resultados as $row): ?>
              <tr>
                ...
                <td><?= htmlspecialchars($row['data_entrega']) ?></td>
                <td><?= htmlspecialchars($row['horas_relatadas']) ?></td>
                <td><?= htmlspecialchars($row['n_relatorio']) ?></td>
                <td><?= htmlspecialchars($row['parecer_tecnico']) ?></td>
